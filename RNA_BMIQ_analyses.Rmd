...
Create_heatmap_corr <- function(DATA, remove_cases = 0, Phenotype, corr_method = "spearman") {
  ...
  ann_colors <- list(
    DNMT3a = c(DNMT3AWT = "blue", DNMT3Am = "red"),
    IDH = c(IDHWT = "blue", IDHm = "red"),
    WT1 = c(WT1WT = "blue", WT1m = "red"),
    FLT3 = c(FLT3AWT = "blue", FLT3m = "red"),
    TET2 = c(TET2WT = "blue", TET2m = "red"))
...
method <- "pearson"
heat_BMIQ_all_data <- Create_heatmap_corr(BMIQ_met, Phenotype = Phenotype_met, method)
single_mutation <- rowSums(design[,c(1:4,7)]) == 0
heat_single_mutation <- Create_heatmap_corr(BMIQ_met, single_mutation, Phenotype_met, method)
...
heat_no_WT <- Create_heatmap_corr(BMIQ_met, no_wild_type, Phenotype_met, method)
...
heat_no_WT_single_mutation <- Create_heatmap_corr(BMIQ_met, no_wild_type_single_mutation, Phenotype_met, method)
...
heat_no_M2_patients <- Create_heatmap_corr(DATA = BMIQ_met, remove_cases = No_Macro_deconv, Phenotype = Phenotype_met, method)
